...
const Formulario = ({pacientes, setPacientes, paciente, setPaciente}) => {
  ...
  return (
    <div className='md:w-1/2 lg:w-2/5 mx-5'>
      ...
      <form className='bg-white shadow-md rounded-lg py-10 px-5 mb-10' onSubmit={handleSubmit} action="#">
        ...
        <div className='mb-5'>
          ...
          <textarea id='sintomas' value={sintomas} onChange={ (e) => setSintomas(e.target.value)} className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md' placeholder='Describe los Sintomas'/>
        </div>
